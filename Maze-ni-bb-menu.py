...
#BG_play = pygame.image.load("C:/Users/ERICKA JANE ALEGRE/Downloads/cpen/maze image/Background.png")
...
BG = pygame.image.load("C:/Users/ERICKA JANE ALEGRE/Downloads/cpen/maze image/stars5.png")
...
#font
def get_font(size):
    return pygame.font.Font("C:/Users/ERICKA JANE ALEGRE/Downloads/cpen/maze image/font.ttf", size)
...
def main_menu():
    ...
    while run:
        ...
        PLAY_BUTTON = Button(image=pygame.image.load("C:/Users/ERICKA JANE ALEGRE/Downloads/cpen/maze image/Play Rect2.png"), pos=(477, 279),
                             text_input="PLAY", font=get_font(50), base_color="#d7fcd4", hovering_color="Green")
        OPTIONS_BUTTON = Button(image=pygame.image.load("C:/Users/ERICKA JANE ALEGRE/Downloads/cpen/maze image/Options Rect2.png"), pos=(477, 370),
                                text_input="OPTIONS", font=get_font(50), base_color="#d7fcd4", hovering_color="Light Green")
        QUIT_BUTTON = Button(image=pygame.image.load("C:/Users/ERICKA JANE ALEGRE/Downloads/cpen/maze image/Options Rect2.png"), pos=(477, 460),
